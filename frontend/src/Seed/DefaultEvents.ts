...
export const seedPeriods = [
    ...
    new TimelinePeriod([-3300], [-900], "Bronze Age"),
    new TimelinePeriod([-1200], [-550], "Iron Age"),
    new TimelinePeriod([-800], [476], "Classical Antiquity"),
    new TimelinePeriod([476], [1453], "Middle Ages"),
    new TimelinePeriod([1400], [1700], "Renaissance"),
    ...
    new TimelinePeriod([1687], [1789], "Age of Enlightenment"),
    new TimelinePeriod([1760], [1914], "Industrial Era"),
