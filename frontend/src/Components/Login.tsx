    ...
    return (
        ...
        >
            ...
            {activeAccount ? [
                ...
                <MenuItem key="logout" onClick={handleLogout} disabled={loading} sx={{fontFamily: 'DM Sans, sans-serif', fontSize: 13}}>
                    {loading ? <CircularProgress size={16} sx={{color: 'white'}} /> : "Log Out"}
                </MenuItem>,
            ] : [
                <MenuItem key="login" onClick={handleRedirect} disabled={loading} sx={{fontFamily: 'DM Sans, sans-serif', fontSize: 13}}>
                    {loading ? <CircularProgress size={16} sx={{color: 'white'}} /> : "Log In"}
                </MenuItem>,
            ]}
            </Menu>
        </div>
